...
namespace Application.Interfaces
{
    ...
    {
        Task AddToWishListAsync(string phoneSlug, string userMail, CancellationToken token);

        Task RemoveFromWishListAsync(string phoneSlug, string userMail, CancellationToken token);
        ...
        Task<List<WishList>> ShowWishListAsync(string userMail, CancellationToken token);
